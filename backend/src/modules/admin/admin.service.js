...
async function getSystemHealth() {
  ...
  const thresholds = {
    dbSizeWarning: Number(process.env.DB_SIZE_WARNING_MB) || 20000,
    dbSizeCritical: Number(process.env.DB_SIZE_CRITICAL_MB) || 60000,
    dbSizeLimit: Number(process.env.DB_SIZE_LIMIT_MB) || 100000,
    connectionWarning: Number(process.env.CONNECTION_WARNING) || 30,
    connectionCritical: Number(process.env.CONNECTION_CRITICAL) || 45,
    memoryWarning: Number(process.env.MEMORY_WARNING_MB) || 5000,
    memoryCritical: Number(process.env.MEMORY_CRITICAL_MB) || 7000,
    cpuWarning: Number(process.env.CPU_WARNING_PCT) || 50,
    cpuCritical: Number(process.env.CPU_CRITICAL_PCT) || 80,
    mqttConnectionsWarning: Number(process.env.MQTT_CONNECTIONS_WARNING) || 1000,
    mqttConnectionsCritical: Number(process.env.MQTT_CONNECTIONS_CRITICAL) || 3000,
    wsClientsWarning: Number(process.env.WS_CLIENTS_WARNING) || 200,
    wsClientsCritical: Number(process.env.WS_CLIENTS_CRITICAL) || 500,
    multiRegionInstallersWarning: Number(process.env.MULTI_REGION_INSTALLERS_WARNING) || 25,
    multiRegionInstallersCritical: Number(process.env.MULTI_REGION_INSTALLERS_CRITICAL) || 100,
    multiRegionDevicesWarning: Number(process.env.MULTI_REGION_DEVICES_WARNING) || 500,
    multiRegionDevicesCritical: Number(process.env.MULTI_REGION_DEVICES_CRITICAL) || 2000,
  };
