...
export function NumberDisplayConfigFields({
	settings,
	onChange,
}: ConfigFieldsProps) {
	return (
		<div className="space-y-3">
			...
			<div className="space-y-1">
				...
				<Input
					type="number"
					value={String(settings.decimals ?? 2)}
					onChange={(e) =>
						onChange({ ...settings, decimals: Number(e.target.value) })
					}
				/>
			</div>
			<div className="space-y-1">
