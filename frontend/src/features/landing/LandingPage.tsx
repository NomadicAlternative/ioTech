...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--prussian-blue)] text-white overflow-x-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-[72px] md:h-[80px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="/login" className="hidden sm:inline text-sm text-white/60 hover:text-white transition-colors">
              {t("landing.nav.login")}
            </a>
            <a
              href="/register"
      ...
      {/* ─── HERO ─── */}
      <section className="relative pt-32 md:pt-44 pb-16 md:pb-32 px-4 md:px-6 overflow-hidden">
        ...
        <canvas ref={canvasRef} className="absolute inset-0 w-full h-[400px] opacity-30 pointer-events-none z-10" />
      ...
      <section className="py-16 md:py-32 px-4 md:px-6 border-t border-white/5">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl md:text-4xl font-bold mb-4">Start building your IoT infrastructure today</h2>
          <p className="text-sm md:text-base text-white/40 mb-10">Get started in less than 2 minutes. No credit card required.</p>
          <a
            href="/register"
