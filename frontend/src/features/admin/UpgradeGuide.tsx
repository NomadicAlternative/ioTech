...
> = {
	...
	"multi-region": {
		title: "Agregar VPS en Estados Unidos (Multi-Región)",
		steps: [
			"Comprar un segundo VPS KVM 2 en Hostinger (región US East) — ~$6/mes",
			"Instalar Mosquitto MQTT + backend Docker (misma DB Neon, misma config)",
			"Configurar DNS: mqtt-us.beepdash.com → IP del VPS US",
			"Los ESP32 en América se conectan a mqtt-us.beepdash.com por latencia",
			"Los dashboards de clientes US usan el backend US (misma DB, datos globales)",
		],
		cost: "~$6/mes por VPS adicional",
		downtime: "Cero — los dos VPS funcionan en paralelo",
