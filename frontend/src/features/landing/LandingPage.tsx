...
export function LandingPage() {
	...
	const valueProps = [
		{
			icon: Cpu,
			title: t("landing.value.title1"),
			desc: t("landing.value.desc1"),
		},
		{
			icon: Zap,
			title: t("landing.value.title2"),
			desc: t("landing.value.desc2"),
		},
		{
			icon: Shield,
			title: t("landing.value.title3"),
			desc: t("landing.value.desc3"),
		},
	];

	const features = [
		{ icon: Cpu, label: t("landing.f1.title") },
		{ icon: Zap, label: t("landing.f2.title") },
		{ icon: RefreshCw, label: t("landing.f3.title") },
		{ icon: BarChart3, label: t("landing.f4.title") },
		{ icon: Wifi, label: t("landing.f5.title") },
		{ icon: Shield, label: t("landing.f6.title") },
	];
		...
		<div className="min-h-screen bg-[var(--prussian-blue)] text-white overflow-x-hidden">
						...
						{[
							{
								step: "01",
								icon: Cpu,
								title: t("landing.flow1.title"),
								desc: t("landing.flow1.desc"),
							},
							{
								step: "02",
								icon: Wifi,
								title: t("landing.flow2.title"),
								desc: t("landing.flow2.desc"),
							},
							{
								step: "03",
								icon: LayoutDashboard,
								title: t("landing.flow3.title"),
								desc: t("landing.flow3.desc"),
							},
			...
			<section className="py-16 md:py-32 px-4 md:px-6 border-t border-white/5">
				<div className="max-w-2xl mx-auto text-center">
					...
					>
						{t("landing.finalCta.button")} <ArrowRight className="h-5 w-5" />
					</a>
				</div>
			</section>
